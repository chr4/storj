...
func newChecker(pointerdb *pointerdb.Server, sdb statdb.DB, repairQueue *queue.Queue, overlay pb.OverlayServer, irrdb irreparabledb.DB, limit int, logger *zap.Logger, interval time.Duration) *checker {
	return &checker{
		statdb:      sdb,
		pointerdb:   pointerdb,
